...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { descripption: @gift.descripption, name: @gift.name, price: @gift.price, user_id: @gift.user_id }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { descripption: @gift.descripption, name: @gift.name, price: @gift.price, user_id: @gift.user_id }
    assert_redirected_to gift_path(assigns(:gift))
  end
